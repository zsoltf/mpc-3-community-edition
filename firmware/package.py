...
RUNTIME_SOURCE = '81f3086'  # commit whose tree built the pinned runtime
...
if '#define OBSERVER_LIBRARY "/data/mpclearn-model.v0_2_0/command-observer.so"' not in (source/'config.h').read_text():
